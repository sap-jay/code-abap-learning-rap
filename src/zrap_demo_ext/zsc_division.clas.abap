...
CLASS zsc_division DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_Z_TRAVEL_AGENCY_ES5_type,
      ...
      END OF tys_Z_TRAVEL_AGENCY_ES5_type,
      "! <p class="shorttext synchronized">List of Z_TRAVEL_AGENCY_ES5Type</p>
      tyt_Z_TRAVEL_AGENCY_ES5_type TYPE STANDARD TABLE OF tys_Z_TRAVEL_AGENCY_ES5_type WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        Z_TRAVEL_AGENCY_ES5 TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_TRAVEL_AGENCY_ES5',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! See also structure type {@link ..tys_Z_TRAVEL_AGENCY_ES5_type}
        BEGIN OF Z_TRAVEL_AGENCY_ES5_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF Z_TRAVEL_AGENCY_ES5_type,
  ...
  PRIVATE SECTION.
    ...
    METHODS def_Z_TRAVEL_AGENCY_ES5_type RAISING /iwbep/cx_gateway.

ENDCLASS.


CLASS zsc_division IMPLEMENTATION.
  ...
  METHOD /iwbep/if_v4_mp_basic_pm~define.
    ...
    def_Z_TRAVEL_AGENCY_ES5_type( ).

  ENDMETHOD.


  METHOD def_Z_TRAVEL_AGENCY_ES5_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_TRAVEL_AGENCY_ES5_TYPE'
                                    is_structure              = VALUE tys_Z_TRAVEL_AGENCY_ES5_type( )
    ...
    lo_entity_set = lo_entity_type->create_entity_set( 'Z_TRAVEL_AGENCY_ES5' ).
