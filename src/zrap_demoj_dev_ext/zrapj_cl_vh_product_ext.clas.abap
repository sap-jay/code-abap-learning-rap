class ZRAPJ_CL_VH_PRODUCT_EXT definition
  public
  final
  create public .
...
public section.
  ...
  types:
    T_PRODUCTS TYPE STANDARD TABLE OF ZRAPJI_VH_PRODUCT_EXT WITH  EMPTY KEY .
...
CLASS ZRAPJ_CL_VH_PRODUCT_EXT IMPLEMENTATION.
...
METHOD IF_RAP_QUERY_PROVIDER~SELECT.
  DATA business_data TYPE TABLE OF ZRAPJI_VH_Product_EXT.
  DATA business_data_line TYPE ZRAPJI_VH_Product_EXT .
